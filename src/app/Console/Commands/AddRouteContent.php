...
class AddRouteContent extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'phobos:add-route
     ...
     * @var string
     */
    protected $description = 'Add HTML/PHP code to the routes/api.php file';
    ...
    {
        $path = 'routes/custom.php';
        $disk_name = config('phobos.root_disk_name');
        ...
        if ($disk->exists($path)) {
            ...
            $command = 'php artisan vendor:publish --provider="Phobos\Framework\PhobosServiceProvider" --tag=custom_routes';
