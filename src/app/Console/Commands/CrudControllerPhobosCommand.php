...
class CrudControllerPhobosCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'phobos:crud-controller';
     ...
     * @var string
     */
    protected $description = 'Generate a Phobos CRUD controller';
